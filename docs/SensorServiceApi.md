...
> Sensor sensorServiceCreateSensor(namespace, body)
...
import org.openapitools.client.api.SensorServiceApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CreateSensorRequest body = new CreateSensorRequest(); // CreateSensorRequest | 
    try {
      Sensor result = apiInstance.sensorServiceCreateSensor(namespace, body);
...
------------- | ------------- | ------------- | -------------
 **namespace** | **String**|  |
 **body** | [**CreateSensorRequest**](CreateSensorRequest.md)|  |
...
> Sensor sensorServiceGetSensor(namespace, name, getOptionsResourceVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Sensor result = apiInstance.sensorServiceGetSensor(namespace, name, getOptionsResourceVersion);
      System.out.println(result);
    } catch (ApiException e) {
...
> SensorList sensorServiceListSensors(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SensorList result = apiInstance.sensorServiceListSensors(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue);
      System.out.println(result);
    } catch (ApiException e) {
...
> Stream_result_of_sensor_LogEntry sensorServiceSensorsLogs(namespace, name, triggerName, grep, podLogOptionsContainer, podLogOptionsFollow, podLogOptionsPrevious, podLogOptionsSinceSeconds, podLogOptionsSinceTimeSeconds, podLogOptionsSinceTimeNanos, podLogOptionsTimestamps, podLogOptionsTailLines, podLogOptionsLimitBytes, podLogOptionsInsecureSkipTLSVerifyBackend)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Stream_result_of_sensor_LogEntry result = apiInstance.sensorServiceSensorsLogs(namespace, name, triggerName, grep, podLogOptionsContainer, podLogOptionsFollow, podLogOptionsPrevious, podLogOptionsSinceSeconds, podLogOptionsSinceTimeSeconds, podLogOptionsSinceTimeNanos, podLogOptionsTimestamps, podLogOptionsTailLines, podLogOptionsLimitBytes, podLogOptionsInsecureSkipTLSVerifyBackend);
      System.out.println(result);
    } catch (ApiException e) {
...
[**Stream_result_of_sensor_LogEntry**](Stream_result_of_sensor_LogEntry.md)
...
> Sensor sensorServiceUpdateSensor(namespace, name, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    String namespace = "namespace_example"; // String | 
    String name = "name_example"; // String | 
    UpdateSensorRequest body = new UpdateSensorRequest(); // UpdateSensorRequest | 
    try {
      Sensor result = apiInstance.sensorServiceUpdateSensor(namespace, name, body);
      System.out.println(result);
    } catch (ApiException e) {
 ...
 **namespace** | **String**|  |
 **name** | **String**|  |
 **body** | [**UpdateSensorRequest**](UpdateSensorRequest.md)|  |
...
> Stream_result_of_sensor_SensorWatchEvent sensorServiceWatchSensors(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue)
...
[**Stream_result_of_sensor_SensorWatchEvent**](Stream_result_of_sensor_SensorWatchEvent.md)
