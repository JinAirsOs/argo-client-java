...
public class PersistentVolumeClaimCondition {
  ...
  private java.time.Instant lastProbeTime;
  ...
  public PersistentVolumeClaimCondition lastProbeTime(java.time.Instant lastProbeTime) {
  ...
  **/
  ...
  public java.time.Instant getLastProbeTime() {
    return lastProbeTime;
  }


  public void setLastProbeTime(java.time.Instant lastProbeTime) {
    this.lastProbeTime = lastProbeTime;
  }


  public PersistentVolumeClaimCondition lastTransitionTime(java.time.Instant lastTransitionTime) {
